...
// (VERSÃO ATUALIZADA - 'todasConsultas' agora é uma lista de objetos)
...
// Modelo para a resposta principal do dashboard (ATUALIZADO)
class DashboardData {
  final String nomePaciente;
  final ProximaConsulta? proximaConsulta; // Pode ser nulo
  
  // --- CAMPO ATUALIZADO ---
  // Antes: final List<DateTime> todasConsultas;
  // Agora:
  ...
  factory DashboardData.fromJson(Map<String, dynamic> json) {
    ...
    final List<dynamic> datasDaApi = json['todasConsultas'] as List<dynamic>? ?? [];
    
    // Converte a lista de JSONs em uma lista de ProximaConsulta
    final List<ProximaConsulta> datasConvertidas = datasDaApi
        .map((consultaJson) => ProximaConsulta.fromJson(consultaJson as Map<String, dynamic>))
        .toList();
