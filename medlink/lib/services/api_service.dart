...
  // Helper: decodifica o payload do JWT (mantido da develop)
...
  // Helper para extrair o tipo de usuário do token JWT (mantido da develop)
...
      // Lógica COMBINADA: aceita 'reagendada' (da feature mobile) e 'confirmada'/'pendente'
...
  // Marcar consulta (mantida a versão da develop com string/string, para evitar conflito)
...
  }
  
  // Cancelar consulta (adicionado da feature mobile)
